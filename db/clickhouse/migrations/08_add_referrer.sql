-- add referrer column
ALTER TABLE umami.website_event ADD COLUMN "referrer" String AFTER "referrer_domain";
ALTER TABLE umami.website_event_stats_hourly ADD COLUMN "referrer" SimpleAggregateFunction(groupArrayArray, Array(String)) AFTER "referrer_domain";
